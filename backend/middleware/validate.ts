...
export const validateRegister = [
  ...
  body('role')
    .equals('Estudiante')
    .withMessage('Solo puedes registrarte como Estudiante. Los demás roles deben ser asignados por un administrador.'),
  body('grado').optional().isInt({ min: 1, max: 10 }).withMessage('El grado debe ser un número entre 1 y 10'),
  validate
];
