...
class RegisterView {
  render() {
      ...
      <div class="card" style="max-width: 400px; margin: 2rem auto;">
        ...
        <div class="card__body">
          <form id="register-form">
            ...
            <div class="form-group" id="fieldgrado" style="display: none;">
    ...
    function getgrado() {
      ...
      if(rol === "Estudiante"){
        document.getElementById('fieldgrado').style.display = "block";
      } else {
        document.getElementById('fieldgrado').style.display = "none";
      }
    }

    const roleSelect = document.getElementById('reg-role');
    roleSelect.addEventListener('change', getgrado);
    ...
    form.addEventListener('submit', async (e) => {
      ...
      const data = {
        ...
        grado: document.getElementById('reg-grado').value || undefined
      };
