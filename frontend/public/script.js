...
const API_BASE_URL = 'http://localhost:3000/api'; // Indicando que el backend esta en 3000, de lo contrario lo busca en 8000 
...
async function sendVerificationCode() {
    ...
    try {
        ...
        // Guardando el id del lead para usarlo en verify-code
        window.leadId = result.leadId;
...
async function verifyCode() {
    ...
    try {
        ...
        const response = await fetch(`${API_BASE_URL}/verify-code`, {
            ...
            body: JSON.stringify({
                idLead: window.leadId, // Aqui va el id del lead
